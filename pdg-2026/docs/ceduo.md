...
2. If a parcel exceeds 10 ha in surface area, the harvest is divided into `ceil(area_ha / 10)` equal-sized sub-harvests that occur at least two years apart. Equal sub-harvests keep each sub-area under the 10-ha limit while avoiding tiny remainders.
...
4. Schedule one cycle of sub-harvests:
   - Divide the area into `ceil(area_ha / 10)` equal chunks.
...
* A standalone parcel of 25 ha with parametro=12 was last harvested in 2015. It is split into 3 equal sub-harvests of ~8.33 ha each, scheduled in 2027, 2029, and 2031, and then similarly in 2039, 2041, and 2043.
...
* Two adjacent parcels of 12 ha with parametro=12 were last harvested in 2015 (A) and 2016 (B). A is split into 2 sub-harvests of 6 ha each, scheduled in 2027, 2029, 2039, and 2041. B cannot be scheduled in 2028-2030. It is pushed to 2031 and 2033, and then to 2043 and 2045.
