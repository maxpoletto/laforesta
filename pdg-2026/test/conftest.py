"""
Pytest configuration and shared fixtures for pdg tests.
"""
...
def trees_df(clear_caches):
    ...
    df = load_trees(["alberi.csv"], TEST_DATA_DIR)
    df = calculate_all_trees_volume(df)
    return df
...
def particelle_df(clear_caches):
    ...
    return load_csv("particelle.csv", TEST_DATA_DIR)
