...
{\footnotesize
@@tpt(alberi=alberi-calcolati.csv,compresa=Serra,comparti=comparti.csv,provv_vol=provv_vol.csv,provv_eta=provv_eta.csv,per_compresa=no,totali=si)
}

\subsection*{Ripresa: Fabrizia}
{\footnotesize
@@tpt(alberi=alberi-calcolati.csv,compresa=Fabrizia,comparti=comparti.csv,provv_vol=provv_vol.csv,provv_eta=provv_eta.csv,per_compresa=no,totali=si)
}

\subsection*{Ripresa: Capistrano}
{\footnotesize
@@tpt(alberi=alberi-calcolati.csv,compresa=Capistrano,comparti=comparti.csv,provv_vol=provv_vol.csv,provv_eta=provv_eta.csv,per_compresa=no,totali=si)
}
