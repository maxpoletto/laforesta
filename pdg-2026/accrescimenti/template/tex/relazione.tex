...
Oltre alla cubatura totale, riportiamo il numero di piante campionate per ciascuna specie, nonché l'intervallo fiduciario al 95\% della stima dei volumi. Il margine d'errore per il volume totale è calcolato come la somma dei margini d'errore di ciascuna specie: rappresenta quindi il caso peggiore, in cui le particelle sono completamente correlate tra loro.

@@tsv(per_particella=no,per_genere=no,intervallo_fiduciario=si,totali=si,stime_totali=si)

Le tabelle alle pagine seguenti forniscono i dettagli per ciascuna particella delle tre comprese.

\subsection*{Stima dei volumi: Capistrano}
@@tsv(compresa=Capistrano,intervallo_fiduciario=si,totali=si,stime_totali=si)
\clearpage
\subsection*{Stima dei volumi: Fabrizia}
@@tsv(compresa=Fabrizia,intervallo_fiduciario=si,totali=si,stime_totali=si)
\clearpage
\subsection*{Serra}
@@tsv(compresa=Serra,intervallo_fiduciario=si,totali=si,stime_totali=si)
