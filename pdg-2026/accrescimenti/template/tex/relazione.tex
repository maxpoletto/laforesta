...
@@prop(compresa=Serra,particella=1)
\subsubsection{Classi diametriche}
@@gcd(compresa=Serra,particella=1,alberi=alberi-calcolati.csv,x_max=24,piccolo=si)
@@tcd(compresa=Serra,particella=1,alberi=alberi-calcolati.csv)
\subsubsection{Volumi}
@@tsv(compresa=Serra,particella=1,alberi=alberi-calcolati.csv,per_genere=si,per_compresa=no,per_particella=no,intervallo_fiduciario=si,totali=si,stime_totali=si)
\subsubsection{Ripresa}
@@tpt(compresa=Serra,particella=1,alberi=alberi-calcolati.csv,comparti=comparti.csv,provv_vol=provv_vol.csv,provv_eta=provv_eta.csv,per_compresa=no,per_particella=no,col_area_ha=no)
\clearpage
