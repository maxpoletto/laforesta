...
@@gsv(alberi=alberi-calcolati.csv,per_compresa=si,per_particella=no,per_genere=si)
...
@@gpt(alberi=alberi-calcolati.csv,comparti=comparti.csv,provv_vol=provv_vol.csv,provv_eta=provv_eta.csv,per_compresa=si,per_particella=no)
