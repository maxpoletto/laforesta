...
@@tsv(per_particella=no,per_genere=no,intervallo_fiduciario=si,totali=si,stime_totali=no)
...
@@tsv(compresa=Capistrano,intervallo_fiduciario=si,totali=si,stime_totali=no)
\clearpage
\subsection*{Stima dei volumi: Fabrizia}
@@tsv(compresa=Fabrizia,intervallo_fiduciario=si,totali=si,stime_totali=no)
\clearpage
\subsection*{Serra}
@@tsv(compresa=Serra,intervallo_fiduciario=si,totali=si,stime_totali=no)
