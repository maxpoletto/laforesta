...
@@prelievi(compresa=Serra,particella=1,alberi=alberi-calcolati.csv,per_compresa=no,per_particella=si,per_genere=si,col_area_ha=si,totali=si,col_eta=no,col_pp_max=no,col_comparto=no)

@@prelievi(compresa=Serra,alberi=alberi-calcolati.csv,per_compresa=no,per_particella=si,per_genere=si,col_area_ha=si,totali=si,col_eta=no,col_pp_max=no,col_comparto=no)
...
\item La parte~\ref{sec:metodo} fornisce un riassunto del metodo di gestione forestale praticato dalla nostra azienda.
