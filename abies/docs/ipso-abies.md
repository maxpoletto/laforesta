...
optional for marks. They are never generated by the import pipeline. Abies may
propose a next number in the UI, but import code preserves what the device or CSV
supplied.
...
- PAI preserved trees must have a positive integer, unique within the parcel.
