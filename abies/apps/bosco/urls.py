...
urlpatterns = [
    ...
    path('observations/data/', views.observations_data,
         name='bosco-observations-data'),
    path('observations/<int:observation_id>/detail/', views.observation_detail,
         name='bosco-observation-detail'),
    path('observations/photos/<int:photo_id>/', views.observation_photo,
         name='bosco-observation-photo'),
