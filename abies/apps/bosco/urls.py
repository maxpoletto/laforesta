...
urlpatterns = [
    ...
    path('observations/form/', views.observation_form_view,
         name='bosco-observation-form-add'),
    path('observations/form/<int:observation_id>/', views.observation_form_view,
         name='bosco-observation-form-edit'),
    path('observations/save/', views.observation_save_view,
         name='bosco-observation-save'),
    path('observations/delete/', views.observation_delete_view,
         name='bosco-observation-delete'),
