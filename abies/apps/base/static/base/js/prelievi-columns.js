...
export const STATIC_COLS = {
  ...
  [S.COL_QUINTALS]:    { label: S.COL_QUINTALS, type: 'number', width: '90px', formatter: fmtDecimal1 },
  [S.COL_VOLUME_M3]:   { label: S.COL_VOLUME_M3, type: 'number', width: '90px', formatter: fmtDecimal2 },
