...
export const FIELD_CLIENT_PHOTO_ID = 'client_photo_id';
...
export const IPSO_MODE_OBSERVATIONS = 'observations';
...
export const FIELD_ACTIVE_ID             = 'active_id';
export const FIELD_ACTIVE_IDS            = 'active_ids';
export const FIELD_IS_ACTIVE             = 'is_active';
export const FIELD_LAT                   = 'lat';
export const FIELD_LON                   = 'lon';
export const FIELD_ACC_M                 = 'acc_m';
...
export const FIELD_PARCELS               = 'parcels';
...
export const FIELD_REFERENCE_VERSION     = 'reference_version';
...
export const FIELD_SPECIES_PCT_PREFIX    = 'sp_';
export const FIELD_TRACTOR_PCT_PREFIX    = 'tr_';
...
export const FIELD_CURRENT_PASSWORD      = 'current_password';
...
export const FIELD_TREES                 = 'trees';
