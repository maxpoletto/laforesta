...
import {
  ...
  IPSO_MODE_FREE_SURVEY, IPSO_MODE_MARTELLATE, IPSO_MODE_PAI,
  IPSO_MODE_SAMPLES,
...
const IMPORT_CONFIG = {
  ...
  [IPSO_MODE_FREE_SURVEY]: {
    url: id => `/api/ipso/uploads/${id}/import-free-survey/`,
    targetField: FIELD_SURVEY_ID,
    targetLabel: S.IPSO_TARGET_SURVEY_LABEL,
...
function referenceLabel(referenceVersion) {
  return referenceVersion === IPSO_REFERENCE_LEGACY_CONVERTED
