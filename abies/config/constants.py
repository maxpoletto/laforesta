...
FIELD_PRESERVED_NUMBER      = 'preserved_number'
...
FIELD_PLANS                 = 'plans'
FIELD_COUNTS                = 'counts'
FIELD_SPECIES_PCT_PREFIX    = 'sp_'
FIELD_TRACTOR_PCT_PREFIX    = 'tr_'
FIELD_NEXT                  = 'next'
...
FIELD_WARNINGS_CONFIRMED    = 'warnings_confirmed'
...
FIELD_PHOTOS                = 'photos'
FIELD_EXISTING_PHOTO_IDS    = 'existing_photo_ids'
FIELD_URL                   = 'url'
...
BOSCO_SPECIES_DIGESTS = (
    *BOSCO_DENDROMETRY_DIGESTS, DIGEST_PRESERVED_TREES,
)
...
IPSO_UPLOAD_FILE_READY = 'upload.ready'
IPSO_UPLOAD_FILE_PHOTOS_DIR = 'photos'
IPSO_UPLOAD_MULTIPART_PAYLOAD_FIELD = 'payload'
IPSO_UPLOAD_MULTIPART_PHOTO_PREFIX = 'photo:'
IPSO_MODE_MARTELLATE = 'martellate'
IPSO_MODE_SAMPLES = 'samples'
IPSO_MODE_FREE_SURVEY = 'free_survey'
IPSO_MODE_OBSERVATIONS = 'observations'
IPSO_UPLOAD_MODES = (
...
IPSO_TARGET_OBSERVATIONS = 'observations'
