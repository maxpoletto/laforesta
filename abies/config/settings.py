...
# JSON CSV imports and Ipso multipart uploads carry operator-provided file
# bytes in request bodies. Django's 2.5 MiB default is too tight, so keep an
# explicit ceiling aligned with the Ipso upload default and allow deployment
# overrides.
DATA_UPLOAD_MAX_MEMORY_SIZE = int(os.environ.get(
    'DJANGO_DATA_UPLOAD_MAX_MEMORY_SIZE', str(IPSO_UPLOAD_MAX_BYTES_DEFAULT),
))
