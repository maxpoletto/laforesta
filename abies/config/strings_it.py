...
IPSO_COL_IMPORTED = 'Importato'
IPSO_COL_IMPORTED_BY = 'Importato da'
IPSO_COL_SESSION = 'Sessione'
...
IPSO_MODE_OBSERVATIONS_LABEL = 'Osservazioni'
IPSO_HISTORY_MARK_LABEL = 'Martellata: {} {} {} ({})'
IPSO_HISTORY_SURVEY_LABEL = 'Rilevamento: {} ({})'
IPSO_REFERENCE_LEGACY_CONVERTED = 'Convertito da CSV storico'
IPSO_COL_STATE = 'Stato'
IPSO_COL_WORK_PACKAGE = 'Contesto'
...
IPSO_ERR_UPLOAD_NOT_REJECTABLE = 'Solo i caricamenti da importare possono essere rifiutati.'
...
IPSO_ERR_SECURITY_NOT_CONFIGURED = 'Token Ipso non configurato.'
IPSO_ERR_UPLOAD_TOO_LARGE = 'Caricamento troppo grande.'
IPSO_ERR_UPLOAD_JSON_MISSING = 'File upload.json non trovato.'
IPSO_ERR_UPLOAD_JSON_INVALID = 'File upload.json non valido.'
IPSO_ERR_UPLOAD_SHA_MISSING = 'File upload.sha256 non trovato.'
IPSO_ERR_UPLOAD_SHA_INVALID = 'File upload.sha256 non valido.'
IPSO_ERR_UPLOAD_CHECKSUM_MISMATCH = 'Checksum del caricamento non corrispondente.'
IPSO_ERR_UPLOAD_PHOTO_MISSING = 'Foto mancante: {}.'
IPSO_ERR_UPLOAD_PHOTO_CHECKSUM = 'Checksum foto non corrispondente: {}.'
IPSO_ERR_UPLOAD_PHOTO_UNSUPPORTED = 'Tipo foto non supportato: {}.'
...
IPSO_ERR_RECORDS_TOO_MANY = 'Il campo records può contenere al massimo {} righe.'
...
IPSO_ERR_IMPORT_RECORD_REGION_NOT_FOUND = 'Riga {}: compresa non trovata.'
...
IPSO_ERR_IMPORT_RECORD_MARK_TARGET_MISMATCH = 'Riga {}: particella fuori dalla destinazione selezionata.'
...
IPSO_ERR_IMPORT_MARK_CONFLICT = 'Numero già utilizzato in questa martellata.'
IPSO_ERR_IMPORT_SAMPLE_CONFLICT = 'Numero albero/pollone già presente nel campione.'
IPSO_ERR_IMPORT_PAI_NUMBER_CONFLICT = 'Numero PAI già presente nella particella.'
IPSO_ERR_IMPORT_OBSERVATION_CONFLICT = 'Osservazione già importata.'
...
IPSO_ERR_RECORD_NUMBER_INVALID = 'Riga {}: numero non valido.'
...
IPSO_ERR_RECORD_TEXT_REQUIRED = 'Riga {}: testo obbligatorio.'
IPSO_ERR_RECORD_CATEGORY_REQUIRED = 'Riga {}: selezionare almeno una categoria.'
IPSO_ERR_RECORD_CATEGORY_IDS_INVALID = 'Riga {}: categorie non valide.'
IPSO_ERR_RECORD_PHOTOS_INVALID = 'Riga {}: foto non valide.'
...
IPSO_ERR_UNKNOWN_OBSERVATION_CATEGORY_ID = 'Categoria osservazione sconosciuta: {}.'
...
ERR_TRACTOR_PCT_SUM = 'Le percentuali dei trattori devono sommare a 0 o 100.'
...
COL_TEXT = 'Testo'
COL_SOURCE = 'Origine'
COL_UPLOAD_SESSION = 'Sessione upload'
COL_CLIENT_RECORD_ID = 'ID record client'
COL_IMPORT_FINGERPRINT = 'Impronta import'
COL_OBSERVATION_CATEGORIES = 'Categorie'
COL_PHOTO_COUNT = 'Foto'
...
LABEL_DEFAULT_LANDING_PAGE = 'Pagina default'
LABEL_DIAMETER_CLASS_MODE = 'Classi diametriche'

SITE_SETTINGS = 'impostazioni sito'
DIAMETER_CLASSES_SAVED = 'Classi diametriche aggiornate.'
ERR_DIAMETER_CLASS_MODE_INVALID = 'Selezionare una modalità valida per le classi diametriche.'
...
TABLE_MANNESI_HOURS = 'Ore squadre'
TABLE_MANNESI_CREDIT = 'Acconto squadre'
TABLE_MANNESI_CREDITS = 'Acconti squadre'
TABLE_IPSO_UPLOAD = 'Caricamento Ipso'
...
ERR_CURRENT_PASSWORD_REQUIRED = 'Password attuale obbligatoria.'
ERR_CURRENT_PASSWORD_INVALID = 'Password attuale non corretta.'
...
ERR_USERNAME_DUPLICATE = 'Nome utente già utilizzato.'
ERR_EMAIL_REQUIRED = 'Email obbligatoria.'
ERR_EMAIL_DUPLICATE = 'Email già utilizzata.'
...
ERR_OTHER_RENAME_FORBIDDEN = 'La specie "{}" non può essere rinominata.'
...
ERR_CSV_INVALID = 'File CSV non valido.'
...
ERR_MARK_VOLUME_NEGATIVE = 'Il volume non può essere negativo.'
ERR_MARK_MASS_NEGATIVE = 'La massa non può essere negativa.'
ERR_MARK_ITEM_CLOSED = 'Il cantiere è chiuso: aggiunta non consentita.'
ERR_MARK_ITEM_MISMATCH = 'La martellata non appartiene al cantiere selezionato.'
...
ERR_TREE_DENDROMETRY_ROW_IDS = 'Selezione alberi non valida.'
...
ERR_BOSCO_COPPICE_METADATA_REQUIRED = '{} obbligatorio per ceduo.'
...
ERR_BOSCO_OBSERVATION_TEXT_REQUIRED = 'Descrizione obbligatoria.'
ERR_BOSCO_OBSERVATION_REGION_REQUIRED = 'Compresa obbligatoria.'
ERR_BOSCO_OBSERVATION_PHOTO_UNSUPPORTED = 'Foto non supportata: {}.'
ERR_BOSCO_OBSERVATION_PHOTO_DUPLICATE = 'Foto duplicata: {}.'
ERR_BOSCO_OBSERVATION_CATEGORIES_REQUIRED = 'Selezionare almeno una categoria.'
ERR_BOSCO_OBSERVATION_CATEGORIES_INVALID = 'Categorie non valide.'
ERR_BOSCO_OBSERVATION_PHOTOS_INVALID = 'Foto non valide.'
LABEL_BOSCO_AVE_AGE = 'Età media'
LABEL_BOSCO_VEG_DESC = 'Descrizione vegetazione'
LABEL_BOSCO_GEO_DESC = 'Descrizione geologia'
LABEL_BOSCO_CUTTING_PLAN = 'Piano dei tagli'
LABEL_BOSCO_HARVEST_MECHANISM = 'Sistema di esbosco'
...
BOSCO_OBSERVATION_NEW_TITLE = 'Nuova osservazione'
BOSCO_OBSERVATION_EDIT_TITLE = 'Modifica osservazione'
BOSCO_OBSERVATION_PHOTO_ADD = '+ Aggiungi'
BOSCO_OBSERVATION_PHOTO_REMOVE = 'Rimuovi foto'
...
CSV_COL_VOLUME_M3      = 'Volume (m³)'        # paired with COL_VOLUME_M3
CSV_COL_HARVEST_PLAN_ITEM_ID = 'ID cantiere'
...
CSV_COL_CUTTING_PLAN   = 'Piano del taglio'
CSV_COL_HARVEST_MECHANISM = 'Sistema di esbosco'
CSV_COL_INTERVAL       = 'Intervallo'
CSV_COL_STANDARDS      = 'Matricine'
...
ERR_CSV_HARVEST_PLAN_ITEM     = 'Riga {}: cantiere sconosciuto o incompatibile ({}).'
ERR_CSV_UNKNOWN_CREW         = 'Riga {}: squadra sconosciuta ({}).'
ERR_CSV_UNKNOWN_PRODUCT      = 'Riga {}: tipo di prodotto sconosciuto ({}).'
ERR_CSV_COPPICE_FIELD_REQUIRED = 'Riga {}: {} obbligatorio per ceduo.'
ERR_CSV_HIGHFOREST_COPPICE_FIELD = 'Riga {}: {} deve essere vuoto per fustaia.'
...
COL_CUTTING_PLAN    = 'Piano dei tagli'
COL_HARVEST_MECHANISM = 'Sistema di esbosco'
COL_STUMPS_PER_HA    = 'Ceppaie / ha'
COL_INTERVENTION_INTERVAL = 'Intervallo interventi'
COL_STANDARDS_PER_HA = 'Matricine / ha'
...
# CSV and zip-archive filenames. Italian by default; localizable so a future
# language gets distinct names.
CSV_FILE_HIGHFOREST = 'fustaia.csv'
CSV_FILE_COPPICE    = 'ceduo.csv'
CSV_FILE_REGRESSION = 'equazioni_ipsometro.csv'
CSV_FILE_DENDROMETRY_TREE_COUNT = 'numero_alberi.csv'
CSV_FILE_DENDROMETRY_VOLUME = 'volume_m3.csv'
CSV_FILE_DENDROMETRY_BASAL_AREA = 'area_basimetrica_m2.csv'
ZIP_FILE_MARK_DENDROMETRY = 'riassunto_dendrometrico_{}.zip'
ZIP_FILE_SURVEY_DENDROMETRY = 'riassunto_dendrometrico_rilevamento_{}.zip'
...
CSV_FILE_GRID_AREAS         = 'aree-saggio.csv'
CSV_FILE_SURVEY_TREES       = 'alberi-rilevamento.csv'
...
DENDROMETRY_VOLUME = 'Volume'
DENDROMETRY_BASAL_AREA = 'Area basimetrica'
...
OBSERVATION_CATEGORY_ASSIGNMENT = 'categoria osservazione'
OBSERVATION_CATEGORY_ASSIGNMENTS = 'categorie osservazioni'
OBSERVATION_PHOTO = 'foto osservazione'
OBSERVATION_PHOTOS = 'foto osservazioni'
